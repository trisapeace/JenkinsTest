...
HtmlDeclaredInTest.prototype.setUp = function() {
	// Test utils object contains helper functions
...
HtmlDeclaredInTest.prototype.testDocumentHtmlScope = function() {
	// This test method makes sense only if it runs last. Theoretically,
	// it is impossible to guarantee the order in which test methods run.
	// If this method does not run last in your set up, try to tweak
	// its name.
